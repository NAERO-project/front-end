...
export const GET_MYPAGE_ORDER_PRODUCT_LIST =
  "order/GET_MYPAGE_ORDER_PRODUCT_LIST"; // 주문 내역 내 주문 상품 리스트
export const GET_PRODUCER_ORDER_LIST = "order/GET_PRODUCER_ORDER_LIST"; // 주문 내역 내 주문 상품 리스트
export const GET_PRODUCER_ORDER_PRODUCT_LIST =
  "order/GET_PRODUCER_ORDER_PRODUCT_LIST"; // 주문 내역의 판매자에게 해당하는 주문 상품 리스트
